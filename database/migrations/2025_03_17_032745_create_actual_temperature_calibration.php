...
return new class extends Migration
{
    ...
    {
        Schema::create('actual_temperature_calibration', function (Blueprint $table) {
            $table->id();
            $table->uuid('uuid');
            ...
            $table->decimal('standar6', 8, 2);
            $table->decimal('standar7', 8, 2);
            ...
            $table->decimal('aktual6', 8, 2);
            $table->decimal('aktual7', 8, 2);
            ...
            $table->uuid('temp_calibration_uuid');
            $table->timestamps();
            $table->softDeletes();

            $table->foreign('temp_calibration_uuid')->references('uuid')->on('temperature_calibration_assets')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('actual_temperature_calibration');
    }
};
