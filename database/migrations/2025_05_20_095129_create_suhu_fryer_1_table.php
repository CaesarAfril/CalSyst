...
return new class extends Migration {
    ...
    {
        Schema::create('suhu_fryer_1', function (Blueprint $table) {
            $table->id();
            $table->foreignId('fryer1_validation_id')->constrained('fryer_1_validation')->onDelete('cascade');
            $table->string('time');
    ...
    {
        Schema::dropIfExists('suhu_fryer_1');
    }
};