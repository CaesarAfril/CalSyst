...
return new class extends Migration {
    ...
    {
        Schema::create('suhu_fryer_2', function (Blueprint $table) {
            $table->id();
            $table->foreignId('fryer2_validation_id')->constrained('fryer_2_validation')->onDelete('cascade');
            $table->string('time');
            ...
            $table->float('display_mesin')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('suhu_fryer_2');
    }
};