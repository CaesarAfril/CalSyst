...
<body>
    ...
    <table class="table-transparent">
        <tr>
            ...
            <td>
                {{$temperature->certificate_number}}
            </td>
        </tr>
        <tr>
            <td>
    ...
    <table class="table-transparent">
        <tr>
            ...
            <td>{{$temperature->asset->category->category}}</td>
            <td></td>
            <td style="width: 16%;">
                Calibration Date
            </td>
            ...
            <td>{{$temperature->calibration_date}}</td>
        </tr>
        <tr>
            <td>
                Manufacturer
        ...
        <tr>
            ...
            <td>
                {{$temperature->asset->series_number}}
            </td>
            <td></td>
            <td style="text-align: center;">
                T (°C) : {{$temperature->initial_temp}}°C
            </td>
            <td></td>
            <td style="text-align: center;">
                RH (%) : {{$temperature->initial_rh}}%
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                {{$temperature->asset->resolution}}°C
            </td>
            <td></td>
            <td style="text-align: center;">
                T (°C) : {{$temperature->final_temp}}°C
            </td>
            <td></td>
            <td style="text-align: center;">
                RH (%) : {{$temperature->final_rh}}%
            </td>
        </tr>
    </table>
    <br>
    ...
    <table class="table-bordered">
        ...
        @foreach($temperature->actual_temps as $actual)
        <tr>
        ...
        <tr>
            ...
            <td colspan="2"><b>{{$temperature->u95}}</b></td>
        </tr>
    </table>

    <p>The uncertainty is taken at a Confidence Level of 95% with a Coverage Factor (k) = {{$temperature->k}}.</p>
    ...
    <table class="table-transparent" style="float: right; text-align: left; width: 40%;">
        <tr>
            <td>Salatiga, {{ $temperature->ttd_date }}</td>
        </tr>
        <tr>
            <td>Technician</td>
        </tr>
