...
<div class="container-xxl flex-grow-1 container-p-y px-0">
    <div class="card px-5 py-5" style="border-radius: 1rem;">
        <h5 class="card-header d-flex justify-content-between align-items-center p-0 mb-4">
            ...
            <a href="{{ route('report.addDataDisplay') }}" class="btn btn-primary">
                +
            </a>
        </h5>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-primary btn-sm" onclick="printPDF('{{ route('Internal_calibration.PrintPDFdisplay', $report->uuid) }}')">
                                Cetak PDF
                            </button>
                            ...
                            <form action="{{ route('display.approve', $report->uuid) }}" method="POST" style="display: inline;">
                                @csrf
