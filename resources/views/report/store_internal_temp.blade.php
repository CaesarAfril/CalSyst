                        ...
                        <div class="form-set">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="standar6[]" step="0.01" class="form-control mb-2 standar">
                                    <input type="number" name="standar7[]" step="0.01" class="form-control mb-2 standar">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="number" name="aktual6[]" step="0.01" class="form-control mb-2 aktual">
                                    <input type="number" name="aktual7[]" step="0.01" class="form-control mb-2 aktual">
