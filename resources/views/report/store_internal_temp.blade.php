...
<div class="container-xxl flex-grow-1 container-p-y px-0">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('report.storeDataTemperature') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-10">
                            <input type="date" name="tanggal" id="tanggal" class="form-control mb-2" value="{{ old('tanggal') }}" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-2">
                    ...
                    <div id="form-container">
                        <div class="form-set">
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="set_suhu[]" class="form-control mb-2" value="{{ old('set_suhu[]') }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="form-label">Penunjukan Standar</label>
                                    <input type="number" name="standar1[]" step="0.01" class="form-control mb-2 standar" value="{{ old('standar1[]') }}">
                                    <input type="number" name="standar2[]" step="0.01" class="form-control mb-2 standar" value="{{ old('standar2[]') }}">
                                    <input type="number" name="standar3[]" step="0.01" class="form-control mb-2 standar" value="{{ old('standar3[]') }}">
                                    <input type="number" name="standar4[]" step="0.01" class="form-control mb-2 standar" value="{{ old('standar4[]') }}">
                                    <input type="number" name="standar5[]" step="0.01" class="form-control mb-2 standar" value="{{ old('standar5[]') }}">
                                    <input type="number" name="standar6[]" step="0.01" class="form-control mb-2 standar" value="{{ old('standar6[]') }}">
                                    <input type="number" name="standar7[]" step="0.01" class="form-control mb-2 standar" value="{{ old('standar7[]') }}">
                                    <label class="form-label">Rata-rata penunjukan standar</label>
                                    <input type="number" name="avgprt[]" step="0.01" class="form-control mb-2 avgprt" readonly value="{{ old('avgprt[]') }}">
                                    <label class="form-label">Standar deviasi penunjukan alat</label>
                                    <input type="number" name="stdevprt[]" step="0.01" class="form-control mb-2 stdevprt" readonly value="{{ old('stedvprt[]') }}">
                                    <label for="correction" class="form-label">Koreksi</label>
                                    <input type="number" name="correction[]" step="0.01" class="form-control mb-2 correction" readonly value="{{ old('correction[]') }}">
                                </div>
                                <div class="col-sm-6">
                                    <label class="form-label">Penunjukan Alat</label>
                                    <input type="number" name="aktual1[]" step="0.01" class="form-control mb-2 aktual" value="{{ old('aktual1[]') }}">
                                    <input type="number" name="aktual2[]" step="0.01" class="form-control mb-2 aktual" value="{{ old('aktual2[]') }}">
                                    <input type="number" name="aktual3[]" step="0.01" class="form-control mb-2 aktual" value="{{ old('aktual3[]') }}">
                                    <input type="number" name="aktual4[]" step="0.01" class="form-control mb-2 aktual" value="{{ old('aktual4[]') }}">
                                    <input type="number" name="aktual5[]" step="0.01" class="form-control mb-2 aktual" value="{{ old('aktual5[]') }}">
                                    <input type="number" name="aktual6[]" step="0.01" class="form-control mb-2 aktual" value="{{ old('aktual6[]') }}">
                                    <input type="number" name="aktual7[]" step="0.01" class="form-control mb-2 aktual" value="{{ old('aktual7[]') }}">
                                    <label class="form-label">Rata-rata penunjukan alat</label>
                                    <input type="number" name="avguut[]" step="0.01" class="form-control mb-2 avguut" readonly value="{{ old('avguut[]') }}">
                                    <label class="form-label">Standar deviasi penunjukan alat</label>
                                    <input type="number" name="stdevuut[]" step="0.01" class="form-control mb-2 stdevuut" readonly value="{{ old('stdevuut[]') }}">
                                    <label class="form-label">U4</label>
                                    <input type="number" name="u4prt[]" step="0.01" class="form-control mb-2 u4prt" readonly value="{{ old('u4prt[]') }}">
                                </div>
                            </div>
                            <hr>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="number" name="avg_stdev_uut" id="avg_stdev_uut" class="form-control mb-2 u4prt" readonly value="{{ old('avg_stdev_uut') }}">
                        <label for="u2" class="form-label">U2</label>
                        <input type="number" name="u2" id="u2" step="0.01" class="form-control mb-2" readonly value="{{ old('u2') }}">
                        <label for="uc" class="form-label">UC</label>
                        <input type="number" name="uc" id="uc" step="0.01" class="form-control mb-2" readonly value="{{ old('uc') }}">
                        <label for="veff" class="form-label">Veff</label>
                        <input type="number" name="veff" id="veff" step="0.01" class="form-control mb-2" readonly value="{{ old('veff') }}">
                    </div>
                    <div class="col-sm-6">
                        <label for="u1" class="form-label">U1</label>
                        <input type="number" name="u1" id="u1" step="0.01" class="form-control mb-2" readonly value="{{ old('u1') }}">
                        <label for="u3" class="form-label">U3</label>
                        <input type="number" name="u3" id="u3" step="0.01" class="form-control mb-2" readonly value="{{ old('u3') }}">
                        <label for="k" class="form-label">K</label>
                        <input type="number" name="k" id="k" step="0.01" class="form-control mb-2" value="2" readonly value="{{ old('k') }}">
                        <label for="u95" class="form-label">U95</label>
                        <input type="number" name="u95" id="u95" step="0.01" class="form-control mb-2" readonly value="{{ old('u95') }}">
                    </div>
                </div>
