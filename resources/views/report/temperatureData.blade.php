...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <h5 class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('report.addDataTemperature') }}" class="btn btn-primary btn-sm">
                +
            </a>
        </h5>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('report.exportDataTemperature', $report->uuid)}}" class="btn btn-success">Export</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
