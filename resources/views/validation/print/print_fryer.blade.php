...
<body>
    ...
    <table class="table-bordered mb-3" style="width: 40%;">
        <tr>
            ...
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->start_testing)->translatedFormat('d F Y') }}</td>
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->start_testing)->format('H:i') }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Waktu Akhir Pengujian</td>
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->end_testing)->translatedFormat('d F Y') }}</td>
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->end_testing)->format('H:i') }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Setting Suhu Mesin (Spek)</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->setting_machine_temperature }} &deg;C</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Waktu Produk Infeed ke Outfeed</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->product_infeed_time }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Suhu Awal Inti Produk</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->initial_core_temperature }} &deg;C (Thermo QC)</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Suhu Akhir Inti Produk</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->final_core_temperature }} &deg;C (Thermo QC)</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->cooking_time }}</td>
        </tr>
    </table>
    ...
    <table class="table-bordered mb-3" style="width: 50%;">
        <tr>
            ...
            <td style="padding: 1px;">{{ $dataFryer1 ->product_name }}</td>
        </tr>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; margin-top: .75rem;">
        <tr>
            ...
            <td style="width: 70%; border: 1px solid black; vertical-align: top; padding: 2px;">
                ...
                {{ $dataFryer1 ->packaging }} <br>
                {{ $dataFryer1 ->machine_name }} <br>
                {{ $dataFryer1 ->dimension }} <br>
                {{ $dataFryer1 ->target_temperature }}
            </td>
        </tr>
    </table>
    ...
    <ul>
        <li>{{ $dataFryer1 ->machine_name_2 }}</li>
    </ul>
    <table class="table-bordered mb-3" style="width: 40%;">
        <tr>
            <td style="padding: 1px;">Merek</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->machine_brand_2 }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Tipe</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->machine_type_2 }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Speed Conv</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->machine_speed_conv_2 }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Kapasitas</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->machine_capacity_2 }}</td>
        </tr>
    </table>

    <h3 style="margin-top: 1rem; margin-bottom: unset;">Lokasi</h3>
    <ul>
        <li>{{ $dataFryer1 ->location }}</li>
        <li>{{ $dataFryer1 ->address }}</li>
    </ul>
    ...
    <div class="row mb-3">
        ...
        <p>{{ $dataFryer1 ->distribution_notes }}</p>
    </div>
    ...
    <div class="row mb-3" style="page-break-before: always;">
        ...
        <p>{{ $dataFryer1 ->out_of_range_notes }}</p>
    </div>
    ...
    <div class="row mb-3">
        ...
        <p>{{ $dataFryer1 ->uniformity_notes }}</p>
    ...
    <div class="row mb-3" style="page-break-before: always;">
        ...
        <p>{{ $dataFryer1 ->transcription_notes }}</p>
    </div>
