...
<body>
    ...
    <table class="table-bordered mb-3" style="width: 40%;">
        <tr>
            ...
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->start_pengujian)->translatedFormat('d F Y') }}</td>
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->start_pengujian)->format('H:i') }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Waktu Akhir Pengujian</td>
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->end_pengujian)->translatedFormat('d F Y') }}</td>
            <td style="padding: 1px;">{{ \Carbon\Carbon::parse($dataFryer1->end_pengujian)->format('H:i') }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Setting Suhu Mesin (Spek)</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->setting_suhu_mesin }} &deg;C</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Waktu Produk Infeed ke Outfeed</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->waktu_produk_infeed }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Suhu Awal Inti Produk</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->suhu_awal_inti }} &deg;C (Thermo QC)</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Suhu Akhir Inti Produk</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->suhu_akhir_inti }} &deg;C (Thermo QC)</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Batck ke-</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->batch }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Waktu Pemasakan</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->waktu_pemasakan }}</td>
        </tr>
    </table>
    ...
    <table class="table-bordered mb-3" style="width: 50%;">
        <tr>
            ...
            <td style="padding: 1px;">{{ $dataFryer1 ->nama_produk }}</td>
        </tr>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid black; margin-top: .75rem;">
        <tr>
            ...
            <td style="width: 70%; border: 1px solid black; vertical-align: top; padding: 2px;">
                {{ $dataFryer1 ->ingredient }} <br>
                {{ $dataFryer1 ->kemasan }} <br>
                {{ $dataFryer1 ->nama_mesin }} <br>
                {{ $dataFryer1 ->dimensi }} <br>
                {{ $dataFryer1 ->target_suhu }}
            </td>
        </tr>
    </table>
    ...
    <ul>
        <li>{{ $dataFryer1 ->nama_mesin_2 }}</li>
    </ul>
    <table class="table-bordered mb-3" style="width: 40%;">
        <tr>
            <td style="padding: 1px;">Merek</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->merek_mesin_2 }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Tipe</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->tipe_mesin_2 }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Speed Conv</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->speed_conv_mesin_2 }}</td>
        </tr>
        <tr>
            <td style="padding: 1px;">Kapasitas</td>
            <td colspan="2" style="padding: 1px;">{{ $dataFryer1 ->kapasitas_mesin_2 }}</td>
        </tr>
    </table>

    <h3 style="margin-top: 1rem; margin-bottom: unset;">Lokasi</h3>
    <ul>
        <li>{{ $dataFryer1 ->lokasi }}</li>
        <li>{{ $dataFryer1 ->alamat }}</li>
    </ul>
    ...
    <div class="row mb-3" style="page-break-before: always;">
        ...
        <p>{{ $dataFryer1 ->notes_luar_range }}</p>
    </div>
    ...
    <div class="row mb-3">
        ...
        <tbody>
            @php
                ...
                $setSuhu = $dataFryer1->setting_suhu_mesin ?? '155';
        ...
        <p>{{ $dataFryer1 ->notes_keseragaman }}</p>
    ...
    <div class="row mb-3" style="page-break-before: always;">
        ...
        <p>{{ $dataFryer1 ->notes_rekaman }}</p>
    </div>

    <div class="row mb-3">
        <h3>KESIMPULAN</h3>
        <p>{{ $dataFryer1 ->kesimpulan }}</p>
    </div>
</body>
</html>