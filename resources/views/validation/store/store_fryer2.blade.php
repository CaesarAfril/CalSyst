...
<div class="container-xxl flex-grow-1 container-p-y px-0">
    <div class="card">
        ...
        <div class="card-body">
            <h3 class="mb-5 mt-4 text-center">Form Fryer CFS 2</h3>
            <form action="{{ route('validation.storeFryer2') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    <div class="col-sm-6 mb-3">
                        <label for="nama_produk" class="form-label">Nama Produk</label>
                        <select name="produk_fryer_2_id" id="produk_fryer_2_id" class="form-control" required>
...
@section('script')
<script>
    document.getElementById('produk_fryer_2_id').addEventListener('change', function () {
