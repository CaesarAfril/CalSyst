...
<div class="container-xxl flex-grow-1 container-p-y px-0">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('validation.storeFryerMarel') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
...
@section('script')
<script>
    document.getElementById('produk_fryer_marel_id').addEventListener('change', function () {
